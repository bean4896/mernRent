...
const UserProfile = (nmd) => {
  ...
  return (
    <div>
       {errorModal && <Modal buttonClass={errorModal.buttonClass}  titleClass={errorModal.titleClass} title={errorModal.title} message={errorModal.message} onConfirm={errorHandler} /> }
